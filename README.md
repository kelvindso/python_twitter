...
```sh
pip install git+https://github.com/wing328/python-twitter.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wing328/python-twitter.git`)
