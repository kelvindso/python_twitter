...
class Get2TweetsSearchStreamResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsSearchStreamResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsSearchStreamResponse:
        """Create an instance of Get2TweetsSearchStreamResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsSearchStreamResponse.parse_obj(obj)

        return Get2TweetsSearchStreamResponse.parse_obj({
