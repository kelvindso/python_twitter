...
class ResourceUnavailableProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceUnavailableProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceUnavailableProblem:
        """Create an instance of ResourceUnavailableProblem from a dict"""
        if type(obj) is not dict:
            return ResourceUnavailableProblem.parse_obj(obj)

        return ResourceUnavailableProblem.parse_obj({
