...
class Get2TweetsSearchAllResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsSearchAllResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsSearchAllResponse:
        """Create an instance of Get2TweetsSearchAllResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsSearchAllResponse.parse_obj(obj)

        return Get2TweetsSearchAllResponse.parse_obj({
