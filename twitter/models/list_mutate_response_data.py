...
class ListMutateResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMutateResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMutateResponseData:
        """Create an instance of ListMutateResponseData from a dict"""
        if type(obj) is not dict:
            return ListMutateResponseData.parse_obj(obj)

        return ListMutateResponseData.parse_obj({
