...
class StreamingTweetResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StreamingTweetResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StreamingTweetResponse:
        """Create an instance of StreamingTweetResponse from a dict"""
        if type(obj) is not dict:
            return StreamingTweetResponse.parse_obj(obj)

        return StreamingTweetResponse.parse_obj({
