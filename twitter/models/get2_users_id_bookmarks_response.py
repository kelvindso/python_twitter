...
class Get2UsersIdBookmarksResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdBookmarksResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdBookmarksResponse:
        """Create an instance of Get2UsersIdBookmarksResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdBookmarksResponse.parse_obj(obj)

        return Get2UsersIdBookmarksResponse.parse_obj({
