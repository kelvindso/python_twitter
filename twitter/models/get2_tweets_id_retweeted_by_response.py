...
class Get2TweetsIdRetweetedByResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsIdRetweetedByResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsIdRetweetedByResponse:
        """Create an instance of Get2TweetsIdRetweetedByResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsIdRetweetedByResponse.parse_obj(obj)

        return Get2TweetsIdRetweetedByResponse.parse_obj({
