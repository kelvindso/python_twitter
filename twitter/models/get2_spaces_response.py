...
from twitter.models import Expansions, Problem, Space
...
class Get2SpacesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2SpacesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2SpacesResponse:
        """Create an instance of Get2SpacesResponse from a dict"""
        if type(obj) is not dict:
            return Get2SpacesResponse.parse_obj(obj)

        return Get2SpacesResponse.parse_obj({
