...
class Get2SpacesIdTweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2SpacesIdTweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2SpacesIdTweetsResponse:
        """Create an instance of Get2SpacesIdTweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2SpacesIdTweetsResponse.parse_obj(obj)

        return Get2SpacesIdTweetsResponse.parse_obj({
