...
class Get2TweetsIdQuoteTweetsResponseMeta(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsIdQuoteTweetsResponseMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsIdQuoteTweetsResponseMeta:
        """Create an instance of Get2TweetsIdQuoteTweetsResponseMeta from a dict"""
        if type(obj) is not dict:
            return Get2TweetsIdQuoteTweetsResponseMeta.parse_obj(obj)

        return Get2TweetsIdQuoteTweetsResponseMeta.parse_obj({
