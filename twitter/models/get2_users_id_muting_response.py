...
class Get2UsersIdMutingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdMutingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdMutingResponse:
        """Create an instance of Get2UsersIdMutingResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdMutingResponse.parse_obj(obj)

        return Get2UsersIdMutingResponse.parse_obj({
