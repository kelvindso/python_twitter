...
class BookmarkMutationResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookmarkMutationResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookmarkMutationResponseData:
        """Create an instance of BookmarkMutationResponseData from a dict"""
        if type(obj) is not dict:
            return BookmarkMutationResponseData.parse_obj(obj)

        return BookmarkMutationResponseData.parse_obj({
