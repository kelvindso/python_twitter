...
class UsersLikesCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsersLikesCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsersLikesCreateRequest:
        """Create an instance of UsersLikesCreateRequest from a dict"""
        if type(obj) is not dict:
            return UsersLikesCreateRequest.parse_obj(obj)

        return UsersLikesCreateRequest.parse_obj({
