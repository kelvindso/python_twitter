...
class Get2TweetsIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsIdResponse:
        """Create an instance of Get2TweetsIdResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsIdResponse.parse_obj(obj)

        return Get2TweetsIdResponse.parse_obj({
