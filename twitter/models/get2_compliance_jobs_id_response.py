...
from twitter.models import ComplianceJob, Problem
...
class Get2ComplianceJobsIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2ComplianceJobsIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2ComplianceJobsIdResponse:
        """Create an instance of Get2ComplianceJobsIdResponse from a dict"""
        if type(obj) is not dict:
            return Get2ComplianceJobsIdResponse.parse_obj(obj)

        return Get2ComplianceJobsIdResponse.parse_obj({
            "data": ComplianceJob.from_dict(obj.get("data")),
