...
class ListFollowedResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListFollowedResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListFollowedResponseData:
        """Create an instance of ListFollowedResponseData from a dict"""
        if type(obj) is not dict:
            return ListFollowedResponseData.parse_obj(obj)

        return ListFollowedResponseData.parse_obj({
