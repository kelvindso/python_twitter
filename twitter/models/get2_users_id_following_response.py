...
class Get2UsersIdFollowingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdFollowingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdFollowingResponse:
        """Create an instance of Get2UsersIdFollowingResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdFollowingResponse.parse_obj(obj)

        return Get2UsersIdFollowingResponse.parse_obj({
