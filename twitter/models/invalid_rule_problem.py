...
class InvalidRuleProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidRuleProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidRuleProblem:
        """Create an instance of InvalidRuleProblem from a dict"""
        if type(obj) is not dict:
            return InvalidRuleProblem.parse_obj(obj)

        return InvalidRuleProblem.parse_obj({
