...
from twitter.models import Expansions, Get2TweetsSearchAllResponseMeta, Problem, Tweet
...
class Get2TweetsSearchRecentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsSearchRecentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsSearchRecentResponse:
        """Create an instance of Get2TweetsSearchRecentResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsSearchRecentResponse.parse_obj(obj)

        return Get2TweetsSearchRecentResponse.parse_obj({
            ...
            "meta": Get2TweetsSearchAllResponseMeta.from_dict(obj.get("meta"))
        })
