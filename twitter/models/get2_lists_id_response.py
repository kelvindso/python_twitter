...
from twitter.models import Expansions, List, Problem
...
class Get2ListsIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2ListsIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2ListsIdResponse:
        """Create an instance of Get2ListsIdResponse from a dict"""
        if type(obj) is not dict:
            return Get2ListsIdResponse.parse_obj(obj)

        return Get2ListsIdResponse.parse_obj({
            "data": obj.get("data"),
