...
class ClientDisconnectedProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientDisconnectedProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientDisconnectedProblem:
        """Create an instance of ClientDisconnectedProblem from a dict"""
        if type(obj) is not dict:
            return ClientDisconnectedProblem.parse_obj(obj)

        return ClientDisconnectedProblem.parse_obj({
