...
class Get2TweetsSampleStreamResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsSampleStreamResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsSampleStreamResponse:
        """Create an instance of Get2TweetsSampleStreamResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsSampleStreamResponse.parse_obj(obj)

        return Get2TweetsSampleStreamResponse.parse_obj({
