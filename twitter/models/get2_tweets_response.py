...
class Get2TweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsResponse:
        """Create an instance of Get2TweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsResponse.parse_obj(obj)

        return Get2TweetsResponse.parse_obj({
