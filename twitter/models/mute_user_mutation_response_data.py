...
class MuteUserMutationResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MuteUserMutationResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MuteUserMutationResponseData:
        """Create an instance of MuteUserMutationResponseData from a dict"""
        if type(obj) is not dict:
            return MuteUserMutationResponseData.parse_obj(obj)

        return MuteUserMutationResponseData.parse_obj({
