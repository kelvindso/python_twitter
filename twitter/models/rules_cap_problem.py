...
class RulesCapProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RulesCapProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RulesCapProblem:
        """Create an instance of RulesCapProblem from a dict"""
        if type(obj) is not dict:
            return RulesCapProblem.parse_obj(obj)

        return RulesCapProblem.parse_obj({
