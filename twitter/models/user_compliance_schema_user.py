...
class UserComplianceSchemaUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserComplianceSchemaUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserComplianceSchemaUser:
        """Create an instance of UserComplianceSchemaUser from a dict"""
        if type(obj) is not dict:
            return UserComplianceSchemaUser.parse_obj(obj)

        return UserComplianceSchemaUser.parse_obj({
            "id": obj.get("id")
        })
