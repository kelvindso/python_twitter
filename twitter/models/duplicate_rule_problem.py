...
class DuplicateRuleProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DuplicateRuleProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DuplicateRuleProblem:
        """Create an instance of DuplicateRuleProblem from a dict"""
        if type(obj) is not dict:
            return DuplicateRuleProblem.parse_obj(obj)

        return DuplicateRuleProblem.parse_obj({
