...
from twitter.models import Media, Variant
...
class AnimatedGif(Media):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnimatedGif:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnimatedGif:
        """Create an instance of AnimatedGif from a dict"""
        if type(obj) is not dict:
            return AnimatedGif.parse_obj(obj)

        return AnimatedGif.parse_obj({
