...
from twitter.models import Expansions, Get2TweetsIdQuoteTweetsResponseMeta, Problem, Tweet
...
class Get2TweetsIdQuoteTweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsIdQuoteTweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsIdQuoteTweetsResponse:
        """Create an instance of Get2TweetsIdQuoteTweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsIdQuoteTweetsResponse.parse_obj(obj)

        return Get2TweetsIdQuoteTweetsResponse.parse_obj({
            ...
            "meta": Get2TweetsIdQuoteTweetsResponseMeta.from_dict(obj.get("meta"))
        })
