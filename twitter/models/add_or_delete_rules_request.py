...
from twitter.models import AddRulesRequest, DeleteRulesRequest
...
class AddOrDeleteRulesRequest(BaseModel):
    ...
    __oneof_schema_1: Optional[AddRulesRequest] = None
    # data type: DeleteRulesRequest
    __oneof_schema_2: Optional[DeleteRulesRequest] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(ADDORDELETERULESREQUEST_ONE_OF_SCHEMAS, const=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddOrDeleteRulesRequest:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> AddOrDeleteRulesRequest:
