...
class TweetCreateResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetCreateResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetCreateResponseData:
        """Create an instance of TweetCreateResponseData from a dict"""
        if type(obj) is not dict:
            return TweetCreateResponseData.parse_obj(obj)

        return TweetCreateResponseData.parse_obj({
            "id": obj.get("id"),
            "text": obj.get("text")
        })
