...
class Get2UsersIdOwnedListsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdOwnedListsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdOwnedListsResponse:
        """Create an instance of Get2UsersIdOwnedListsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdOwnedListsResponse.parse_obj(obj)

        return Get2UsersIdOwnedListsResponse.parse_obj({
            "data": obj.get("data"),
