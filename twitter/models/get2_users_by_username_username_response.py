...
class Get2UsersByUsernameUsernameResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersByUsernameUsernameResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersByUsernameUsernameResponse:
        """Create an instance of Get2UsersByUsernameUsernameResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersByUsernameUsernameResponse.parse_obj(obj)

        return Get2UsersByUsernameUsernameResponse.parse_obj({
