...
class Get2UsersIdTweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdTweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdTweetsResponse:
        """Create an instance of Get2UsersIdTweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdTweetsResponse.parse_obj(obj)

        return Get2UsersIdTweetsResponse.parse_obj({
