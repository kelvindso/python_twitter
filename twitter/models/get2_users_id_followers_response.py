...
class Get2UsersIdFollowersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdFollowersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdFollowersResponse:
        """Create an instance of Get2UsersIdFollowersResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdFollowersResponse.parse_obj(obj)

        return Get2UsersIdFollowersResponse.parse_obj({
