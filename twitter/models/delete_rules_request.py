...
from twitter.models import DeleteRulesRequestDelete
...
class DeleteRulesRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteRulesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteRulesRequest:
        """Create an instance of DeleteRulesRequest from a dict"""
        if type(obj) is not dict:
            return DeleteRulesRequest.parse_obj(obj)

        return DeleteRulesRequest.parse_obj({
            "delete": DeleteRulesRequestDelete.from_dict(obj.get("delete"))
        })
