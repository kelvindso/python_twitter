...
class Get2UsersIdFollowedListsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdFollowedListsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdFollowedListsResponse:
        """Create an instance of Get2UsersIdFollowedListsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdFollowedListsResponse.parse_obj(obj)

        return Get2UsersIdFollowedListsResponse.parse_obj({
            "data": obj.get("data"),
