...
class Get2ListsIdMembersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2ListsIdMembersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2ListsIdMembersResponse:
        """Create an instance of Get2ListsIdMembersResponse from a dict"""
        if type(obj) is not dict:
            return Get2ListsIdMembersResponse.parse_obj(obj)

        return Get2ListsIdMembersResponse.parse_obj({
