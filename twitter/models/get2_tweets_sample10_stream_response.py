...
from twitter.models import Expansions, Problem, Tweet
...
class Get2TweetsSample10StreamResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsSample10StreamResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsSample10StreamResponse:
        """Create an instance of Get2TweetsSample10StreamResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsSample10StreamResponse.parse_obj(obj)

        return Get2TweetsSample10StreamResponse.parse_obj({
