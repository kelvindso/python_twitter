...
from twitter.models import Expansions, Get2ListsIdFollowersResponseMeta, Problem, Tweet
...
class Get2UsersIdLikedTweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdLikedTweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdLikedTweetsResponse:
        """Create an instance of Get2UsersIdLikedTweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdLikedTweetsResponse.parse_obj(obj)

        return Get2UsersIdLikedTweetsResponse.parse_obj({
