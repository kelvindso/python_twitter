...
class UrlImage(BaseModel):
    ...
    url: Optional[StrictStr] = Field(None, description="A validly formatted URL.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UrlImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UrlImage:
        """Create an instance of UrlImage from a dict"""
        if type(obj) is not dict:
            return UrlImage.parse_obj(obj)

        return UrlImage.parse_obj({
