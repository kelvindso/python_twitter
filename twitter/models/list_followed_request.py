...
class ListFollowedRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListFollowedRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListFollowedRequest:
        """Create an instance of ListFollowedRequest from a dict"""
        if type(obj) is not dict:
            return ListFollowedRequest.parse_obj(obj)

        return ListFollowedRequest.parse_obj({
