...
class TweetTakedownComplianceSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetTakedownComplianceSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetTakedownComplianceSchema:
        """Create an instance of TweetTakedownComplianceSchema from a dict"""
        if type(obj) is not dict:
            return TweetTakedownComplianceSchema.parse_obj(obj)

        return TweetTakedownComplianceSchema.parse_obj({
