...
class ListPinnedResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPinnedResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPinnedResponseData:
        """Create an instance of ListPinnedResponseData from a dict"""
        if type(obj) is not dict:
            return ListPinnedResponseData.parse_obj(obj)

        return ListPinnedResponseData.parse_obj({
