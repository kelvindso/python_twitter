...
class TweetReferencedTweetsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetReferencedTweetsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetReferencedTweetsInner:
        """Create an instance of TweetReferencedTweetsInner from a dict"""
        if type(obj) is not dict:
            return TweetReferencedTweetsInner.parse_obj(obj)

        return TweetReferencedTweetsInner.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
