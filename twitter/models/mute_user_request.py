...
class MuteUserRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MuteUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MuteUserRequest:
        """Create an instance of MuteUserRequest from a dict"""
        if type(obj) is not dict:
            return MuteUserRequest.parse_obj(obj)

        return MuteUserRequest.parse_obj({
