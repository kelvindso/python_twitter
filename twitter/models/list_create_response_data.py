...
class ListCreateResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCreateResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCreateResponseData:
        """Create an instance of ListCreateResponseData from a dict"""
        if type(obj) is not dict:
            return ListCreateResponseData.parse_obj(obj)

        return ListCreateResponseData.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
