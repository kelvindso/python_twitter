...
class UsersFollowingCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsersFollowingCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsersFollowingCreateRequest:
        """Create an instance of UsersFollowingCreateRequest from a dict"""
        if type(obj) is not dict:
            return UsersFollowingCreateRequest.parse_obj(obj)

        return UsersFollowingCreateRequest.parse_obj({
