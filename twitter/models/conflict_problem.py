...
class ConflictProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConflictProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConflictProblem:
        """Create an instance of ConflictProblem from a dict"""
        if type(obj) is not dict:
            return ConflictProblem.parse_obj(obj)

        return ConflictProblem.parse_obj({
