...
class Get2UsersIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdResponse:
        """Create an instance of Get2UsersIdResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdResponse.parse_obj(obj)

        return Get2UsersIdResponse.parse_obj({
