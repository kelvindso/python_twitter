...
class UsageCapExceededProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageCapExceededProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageCapExceededProblem:
        """Create an instance of UsageCapExceededProblem from a dict"""
        if type(obj) is not dict:
            return UsageCapExceededProblem.parse_obj(obj)

        return UsageCapExceededProblem.parse_obj({
