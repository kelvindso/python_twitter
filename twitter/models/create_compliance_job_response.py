...
class CreateComplianceJobResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateComplianceJobResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateComplianceJobResponse:
        """Create an instance of CreateComplianceJobResponse from a dict"""
        if type(obj) is not dict:
            return CreateComplianceJobResponse.parse_obj(obj)

        return CreateComplianceJobResponse.parse_obj({
