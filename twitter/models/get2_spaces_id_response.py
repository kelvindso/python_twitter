...
class Get2SpacesIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2SpacesIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2SpacesIdResponse:
        """Create an instance of Get2SpacesIdResponse from a dict"""
        if type(obj) is not dict:
            return Get2SpacesIdResponse.parse_obj(obj)

        return Get2SpacesIdResponse.parse_obj({
            "data": Space.from_dict(obj.get("data")),
