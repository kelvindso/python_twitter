...
class Get2UsersIdMentionsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdMentionsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdMentionsResponse:
        """Create an instance of Get2UsersIdMentionsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdMentionsResponse.parse_obj(obj)

        return Get2UsersIdMentionsResponse.parse_obj({
