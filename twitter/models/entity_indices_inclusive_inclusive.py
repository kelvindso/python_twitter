...
class EntityIndicesInclusiveInclusive(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityIndicesInclusiveInclusive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityIndicesInclusiveInclusive:
        """Create an instance of EntityIndicesInclusiveInclusive from a dict"""
        if type(obj) is not dict:
            return EntityIndicesInclusiveInclusive.parse_obj(obj)

        return EntityIndicesInclusiveInclusive.parse_obj({
            "end": obj.get("end"),
            "start": obj.get("start")
        })
