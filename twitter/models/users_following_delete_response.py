...
class UsersFollowingDeleteResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsersFollowingDeleteResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsersFollowingDeleteResponse:
        """Create an instance of UsersFollowingDeleteResponse from a dict"""
        if type(obj) is not dict:
            return UsersFollowingDeleteResponse.parse_obj(obj)

        return UsersFollowingDeleteResponse.parse_obj({
