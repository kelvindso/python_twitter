...
class Get2ListsIdFollowersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2ListsIdFollowersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2ListsIdFollowersResponse:
        """Create an instance of Get2ListsIdFollowersResponse from a dict"""
        if type(obj) is not dict:
            return Get2ListsIdFollowersResponse.parse_obj(obj)

        return Get2ListsIdFollowersResponse.parse_obj({
