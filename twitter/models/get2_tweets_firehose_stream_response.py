...
class Get2TweetsFirehoseStreamResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsFirehoseStreamResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsFirehoseStreamResponse:
        """Create an instance of Get2TweetsFirehoseStreamResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsFirehoseStreamResponse.parse_obj(obj)

        return Get2TweetsFirehoseStreamResponse.parse_obj({
