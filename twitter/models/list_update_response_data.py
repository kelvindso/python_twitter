...
class ListUpdateResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUpdateResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUpdateResponseData:
        """Create an instance of ListUpdateResponseData from a dict"""
        if type(obj) is not dict:
            return ListUpdateResponseData.parse_obj(obj)

        return ListUpdateResponseData.parse_obj({
