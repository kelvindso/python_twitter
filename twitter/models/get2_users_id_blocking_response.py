...
class Get2UsersIdBlockingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdBlockingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdBlockingResponse:
        """Create an instance of Get2UsersIdBlockingResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdBlockingResponse.parse_obj(obj)

        return Get2UsersIdBlockingResponse.parse_obj({
