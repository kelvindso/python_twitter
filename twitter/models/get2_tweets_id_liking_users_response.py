...
class Get2TweetsIdLikingUsersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2TweetsIdLikingUsersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2TweetsIdLikingUsersResponse:
        """Create an instance of Get2TweetsIdLikingUsersResponse from a dict"""
        if type(obj) is not dict:
            return Get2TweetsIdLikingUsersResponse.parse_obj(obj)

        return Get2TweetsIdLikingUsersResponse.parse_obj({
