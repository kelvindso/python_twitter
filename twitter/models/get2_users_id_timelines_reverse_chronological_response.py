...
from twitter.models import Expansions, Get2UsersIdMentionsResponseMeta, Problem, Tweet
...
class Get2UsersIdTimelinesReverseChronologicalResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdTimelinesReverseChronologicalResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdTimelinesReverseChronologicalResponse:
        """Create an instance of Get2UsersIdTimelinesReverseChronologicalResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdTimelinesReverseChronologicalResponse.parse_obj(obj)

        return Get2UsersIdTimelinesReverseChronologicalResponse.parse_obj({
            "data": [Tweet.from_dict(_item) for _item in obj.get("data")],
            "errors": [Problem.from_dict(_item) for _item in obj.get("errors")],
            "includes": Expansions.from_dict(obj.get("includes")),
            "meta": Get2UsersIdMentionsResponseMeta.from_dict(obj.get("meta"))
        })
