...
class TweetDeleteComplianceSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetDeleteComplianceSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetDeleteComplianceSchema:
        """Create an instance of TweetDeleteComplianceSchema from a dict"""
        if type(obj) is not dict:
            return TweetDeleteComplianceSchema.parse_obj(obj)

        return TweetDeleteComplianceSchema.parse_obj({
            "delete": TweetComplianceSchema.from_dict(obj.get("delete"))
        })
