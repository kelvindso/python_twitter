...
class Get2ListsIdTweetsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2ListsIdTweetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2ListsIdTweetsResponse:
        """Create an instance of Get2ListsIdTweetsResponse from a dict"""
        if type(obj) is not dict:
            return Get2ListsIdTweetsResponse.parse_obj(obj)

        return Get2ListsIdTweetsResponse.parse_obj({
