...
class ResourceUnauthorizedProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceUnauthorizedProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceUnauthorizedProblem:
        """Create an instance of ResourceUnauthorizedProblem from a dict"""
        if type(obj) is not dict:
            return ResourceUnauthorizedProblem.parse_obj(obj)

        return ResourceUnauthorizedProblem.parse_obj({
