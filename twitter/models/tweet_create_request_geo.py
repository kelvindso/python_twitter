...
class TweetCreateRequestGeo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetCreateRequestGeo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetCreateRequestGeo:
        """Create an instance of TweetCreateRequestGeo from a dict"""
        if type(obj) is not dict:
            return TweetCreateRequestGeo.parse_obj(obj)

        return TweetCreateRequestGeo.parse_obj({
