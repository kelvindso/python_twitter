...
from twitter.models import Expansions, Get2ListsIdFollowersResponseMeta, List, Problem
...
class Get2UsersIdListMembershipsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersIdListMembershipsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersIdListMembershipsResponse:
        """Create an instance of Get2UsersIdListMembershipsResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersIdListMembershipsResponse.parse_obj(obj)

        return Get2UsersIdListMembershipsResponse.parse_obj({
            "data": obj.get("data"),
