...
class TweetHideResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetHideResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetHideResponseData:
        """Create an instance of TweetHideResponseData from a dict"""
        if type(obj) is not dict:
            return TweetHideResponseData.parse_obj(obj)

        return TweetHideResponseData.parse_obj({
