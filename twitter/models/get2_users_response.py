...
class Get2UsersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersResponse:
        """Create an instance of Get2UsersResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersResponse.parse_obj(obj)

        return Get2UsersResponse.parse_obj({
