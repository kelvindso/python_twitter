...
class TweetDropComplianceSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TweetDropComplianceSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TweetDropComplianceSchema:
        """Create an instance of TweetDropComplianceSchema from a dict"""
        if type(obj) is not dict:
            return TweetDropComplianceSchema.parse_obj(obj)

        return TweetDropComplianceSchema.parse_obj({
            "drop": TweetComplianceSchema.from_dict(obj.get("drop"))
        })
