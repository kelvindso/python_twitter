...
class BookmarkAddRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookmarkAddRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookmarkAddRequest:
        """Create an instance of BookmarkAddRequest from a dict"""
        if type(obj) is not dict:
            return BookmarkAddRequest.parse_obj(obj)

        return BookmarkAddRequest.parse_obj({
