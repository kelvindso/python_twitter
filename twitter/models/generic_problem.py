...
class GenericProblem(Problem):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenericProblem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenericProblem:
        """Create an instance of GenericProblem from a dict"""
        if type(obj) is not dict:
            return GenericProblem.parse_obj(obj)

        return GenericProblem.parse_obj({
