...
class Get2UsersByResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Get2UsersByResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Get2UsersByResponse:
        """Create an instance of Get2UsersByResponse from a dict"""
        if type(obj) is not dict:
            return Get2UsersByResponse.parse_obj(obj)

        return Get2UsersByResponse.parse_obj({
