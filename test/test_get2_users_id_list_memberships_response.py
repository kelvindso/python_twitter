...
import twitter
from twitter.models.get2_users_id_list_memberships_response import Get2UsersIdListMembershipsResponse  # noqa: E501
...
class TestGet2UsersIdListMembershipsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = twitter.models.get2_users_id_list_memberships_response.Get2UsersIdListMembershipsResponse()  # noqa: E501
        if include_optional :
            return Get2UsersIdListMembershipsResponse(
                data = [
                    twitter.models.list.List(
                ...
                meta = twitter.models.get2_lists_id_followers_response_meta.Get2ListsIdFollowersResponse_meta(
                    next_token = '0', 
                    previous_token = '0', 
                    result_count = 56, )
            )
