...
import twitter
from twitter.models.get2_lists_id_response import Get2ListsIdResponse  # noqa: E501
...
class TestGet2ListsIdResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = twitter.models.get2_lists_id_response.Get2ListsIdResponse()  # noqa: E501
        if include_optional :
            return Get2ListsIdResponse(
                data = twitter.models.list.List(
