...
import twitter
from twitter.models.list_delete_response import ListDeleteResponse  # noqa: E501
...
class TestListDeleteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = twitter.models.list_delete_response.ListDeleteResponse()  # noqa: E501
        if include_optional :
            return ListDeleteResponse(
                data = twitter.models.list_delete_response_data.ListDeleteResponse_data(
                    deleted = True, ), 
                errors = [
