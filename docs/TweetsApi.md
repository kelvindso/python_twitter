...
with twitter.ApiClient(configuration) as api_client:
    ...
    users_likes_create_request = twitter.UsersLikesCreateRequest() # UsersLikesCreateRequest |  (optional)
...
with twitter.ApiClient(configuration) as api_client:
    ...
    users_retweets_create_request = twitter.UsersRetweetsCreateRequest() # UsersRetweetsCreateRequest |  (optional)
